...
class Game{
  static final boardlenth = 9;//we will create a board of 3*3 blocks;
  ...
  //for this we need first to declare a score board in our main file 
  bool winnerCheck(String player, int index, List<int> scoreboard, int gridSize){
    //first lets declare the row and col
    int row = index~/ 3;
    int col = index % 3;
    ...
    //checking if we have 3 or -3 int the score board
